/*
 * @Author: wangyun
 * @CreateTime: 2023-01-19 21:29:42 250
 * @LastEditor: wangyun
 * @EditTime: 2023-01-19 21:29:42 256
 */
...
namespace Control {
	public enum StateCtrlParticleEmissionRateType {
		RATE_OVER_TIME,
		RATE_OVER_DISTANCE = 1,
	}
	public class StateCtrlParticleEmissionRate : BaseStateCtrl<ParticleSystem.MinMaxCurve> {
		public StateCtrlParticleEmissionRateType type = StateCtrlParticleEmissionRateType.RATE_OVER_TIME;
		...
		protected ParticleSystem.MinMaxCurve Rate {
			get {
				if (Particle) {
					switch (type) {
						case StateCtrlParticleEmissionRateType.RATE_OVER_TIME:
							return Particle.emission.rateOverTime;
						case StateCtrlParticleEmissionRateType.RATE_OVER_DISTANCE:
