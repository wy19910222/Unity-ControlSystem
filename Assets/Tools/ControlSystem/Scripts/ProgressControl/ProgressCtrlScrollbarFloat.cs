/*
 * @Author: wangyun
 * @CreateTime: 2023-02-26 22:19:35 725
 * @LastEditor: wangyun
 * @EditTime: 2023-02-26 22:19:35 731
 */
...
namespace Control {
	public enum ProgressCtrlScrollbarFloatType {
		VALUE,
		SIZE
	}
	
	[RequireComponent(typeof(Scrollbar))]
	public class ProgressCtrlScrollbarFloat : BaseProgressCtrlFloat {
		public ProgressCtrlScrollbarFloatType type;
		...
		private float Value {
			get {
				...
				if (scrollbar) {
					switch (type) {
						case ProgressCtrlScrollbarFloatType.VALUE:
							return scrollbar.value;
						case ProgressCtrlScrollbarFloatType.SIZE:
